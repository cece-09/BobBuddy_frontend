...
const BottomSheet: React.FC<BottomSheetProps> = ({ open, onClose, item, onSaveButtonClick, }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isEditing ? (
          <Button fullWidth variant="contained" onClick={handleSaveClick}>저장하기</Button>
        ) : (
          <Button fullWidth variant="contained" onClick={handleEditClick}>수정하기</Button>
        )}
      </Box>
    </Drawer>
  );
